...
const BannerJob = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-red-500 via-orange-500 to-amber-600 mb-8">
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute top-1/4 -left-20 w-80 h-80 bg-amber-300/20 rounded-full blur-xl"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.2, 0.4, 0.2],
          }}
